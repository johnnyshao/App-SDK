...
class TabBarController : UITabBarController, UITabBarControllerDelegate {
    ...
    func signOut() -> Void {
        ...
        guard let wmaIdentityProvider = self.wmaIdentityProvider else { return }
        ...
        for user in userManager.getUsers() {
            ...
            let _ = wmaIdentityProvider.logOut(user: user!, cancellationToken: TkCancellationToken_None);
