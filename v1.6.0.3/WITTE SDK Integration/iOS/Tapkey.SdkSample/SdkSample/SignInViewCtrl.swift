...
class SignInViewController: UIViewController {
    ...
    var wmaIdentityProvider: WmaIdentityProvider?;
    ...
    override func viewDidLoad() {
        ...
        self.wmaIdentityProvider = app.getWmaIdentityProvider();
    ...
    @IBAction func onClickSignIn(sender: UIButton) {
        ...
        // sign in to the WMA tenant
        let app:AppDelegate = UIApplication.shared.delegate as! AppDelegate;
        let identity = TkModelIdentity(nsString: "wma.oauth", with: app.wmaToken);
        self.userManager!.authenticateAsync(identity: identity!, cancellationToken: TkCancellationToken_None)
